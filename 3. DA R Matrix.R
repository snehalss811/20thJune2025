...
mat1= matrix(c(2,5,1,4,5,6),nrow=2,ncol=3,byrow=FALSE)
mat1 # will repeat values column wisemat1 # will repeat values column wise
...
num_views=72  # to execute this code select line number 62 to 67 and click on run
if(num_views>20)
{
...
# else-if
marks=6 # Try 90,80,75,60,55,40,35,20
if(marks>80){
  print("Excellent")
...
var1 = as.numeric(readline(prompt = "Enter any number : "));
var2=50
var3=60
var4=70
